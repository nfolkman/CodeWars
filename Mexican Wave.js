/* Description: The wave (known as the Mexican wave in the English-speaking world outside North America) 
...
function wave(str){
    let result = []
        ...
        let newArrOfStr = str.split('')
    
            if(newArrOfStr[i] === ' ') continue
    
            newArrOfStr[i] = newArrOfStr[i].toUpperCase()
            result.push(newArrOfStr.join(''))
        }
